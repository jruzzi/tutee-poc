...
<table cellspacing="0" cellpadding="0" width="100">
<tr>
<td align="center"><a href="overview001.adoc"><img src="img/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a>&nbsp;</td>
<td align="center"><a href="overview003.adoc"><img src="img/rightnav.gif" alt="Next" /><br />
...
** link:overview008.adoc#CJAJHGIH[Batch Applications for the Java
Platform]
** link:overview008.adoc#CJAFGFCJ[Concurrency Utilities for Java EE]
** link:overview008.adoc#CJAGIEEI[Java API for JSON Processing] (JSON-P)
** link:overview008.adoc#CJAHDJBJ[Java API for WebSocket]
* New features for EJB components (see
link:overview008.adoc#BNACL[Enterprise JavaBeans Technology] for details)
* New features for servlets (see link:overview008.adoc#BNACM[Java Servlet
Technology] for details)
* New features for JavaServer Faces components (see
link:overview008.adoc#BNACP[JavaServer Faces Technology] for details)
* New features for the Java Message Service (JMS) (see
link:overview008.adoc#BNACQ[Java Message Service API] for details)
