...
<table cellspacing="0" cellpadding="0" width="100">
<tr>
<td align="center"><a href="overview004.adoc"><img src="img/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a>&nbsp;</td>
<td align="center"><a href="overview006.adoc"><img src="img/rightnav.gif" alt="Next" /><br />
...
link:img_text/jeett_dt_005.adoc[Description of "Figure 1-5 Java EE Server
and Containers"] +
 +
