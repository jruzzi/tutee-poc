...
<tbody>
<tr class="odd">
<td><a href="jsf-el008.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="jsf-page001.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
Many of the examples in this chapter are taken from [Chapter 57, "Duke's
Bookstore Case Study Example."](dukes-bookstore.htm#GLNVI)

The following topics are addressed here:

  - [Setting Up a Page](jsf-page001.htm#BNARB)

  - [Adding Components to a Page Using HTML Tag Library
    Tags](jsf-page002.htm#BNARF)

  - [Using Core Tags](jsf-page003.htm#BNARC)
