...
<tbody>
<tr class="odd">
<td><a href="bean-validation.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="bean-validation002.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
Application](jsf-facelets003.htm#GIPOB). The `guessnumber-jsf` example
