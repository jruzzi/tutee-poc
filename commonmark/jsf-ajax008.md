...
<tbody>
<tr class="odd">
<td><a href="jsf-ajax007.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="jsf-ajax009.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
As described in [Partial Processing and Partial
Rendering](jsf-intro008.htm#GKNOJ), when an Ajax request is received,
the state associated with that request is captured by the
