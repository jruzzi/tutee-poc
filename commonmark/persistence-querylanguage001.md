...
<tbody>
<tr class="odd">
<td><a href="persistence-querylanguage.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="persistence-querylanguage002.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
conceptual information, see [Chapter 37, "Introduction to the Java
Persistence API"](persistence-intro.htm#BNBPZ). For code examples, see
[Chapter 38, "Running the Persistence
Examples."](persistence-basicexamples.htm#GIJST)
