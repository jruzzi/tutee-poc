...
<tbody>
<tr class="odd">
<td><a href="persistence-entitygraphs003.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="persistence-cache.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
property name and an `EntityGraph` instance as the
value:
