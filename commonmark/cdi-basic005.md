...
<tbody>
<tr class="odd">
<td><a href="cdi-basic004.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="cdi-basic006.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
The following kinds of objects can be injected:
  ...
  - Java EE resources: data sources, Java Message Service topics,
    queues, connection factories, and the like
...
This bean is not exposed to the EL in this form. [Giving Beans EL
Names](cdi-basic009.htm#GJBAK) explains how you can make a bean
