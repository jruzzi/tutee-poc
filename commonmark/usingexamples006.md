...
<tbody>
<tr class="odd">
<td><a href="usingexamples005.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="usingexamples007.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
file, its submodule directories use the following naming conventions:
  ...
  - example-name`-common`: library JAR containing components, classes,
    and files used by other modules
