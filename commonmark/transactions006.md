...
<tbody>
<tr class="odd">
<td><a href="transactions005.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="transactions007.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
Console to configure the transaction timeout interval. See [Starting the
Administration Console](usingexamples003.htm#BNADJ).
...
2.  On the Transaction Service page, set the value of the Transaction
    ...
    The default value is 0, meaning that the transaction will not time
    out.
