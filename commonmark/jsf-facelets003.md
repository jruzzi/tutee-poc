...
<tbody>
<tr class="odd">
<td><a href="jsf-facelets002.htm"><img src="../../dcommon/gifs/leftnav.gif" alt="Previous" /><br />
<span class="icon">Previous</span></a> </td>
<td><a href="jsf-facelets004.htm"><img src="../../dcommon/gifs/rightnav.gif" alt="Next" /><br />
...
The following topics are addressed here:
  ...
  - [Section 8.3.1, "Creating a Facelets Application"](#GIQTE)

  - [Section 8.3.2, "Configuring the Application"](#GJJKC)

  - [Section 8.3.3, "Running the guessnumber-jsf Facelets
    Example"](#GIRGF)
...
The following topics are addressed here:
  ...
  - [Section 8.3.3.1, "To Build, Package, and Deploy the guessnumber-jsf
    Example Using NetBeans IDE"](#GJQZL)

  - [Section 8.3.3.2, "To Build, Package, and Deploy the guessnumber-jsf
    Example Using Maven"](#GJQYU)

  - [Section 8.3.3.3, "To Run the guessnumber-jsf
Example"](#GJQYX)
...
4.  If you guessed incorrectly, click Back to return to the main page.
    ...
    You can continue to guess until you get the correct answer, or you
    can look in the server log, where the `UserNumberBean` constructor
