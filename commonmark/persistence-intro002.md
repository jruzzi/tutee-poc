...
<td><p>All cascade operations will be applied to the parent entity's related entity. <code dir="ltr">All</code> is equivalent to specifying <code dir="ltr">cascade={DETACH, MERGE, PERSIST, REFRESH, REMOVE}</code></p></td>
</tr>
<tr class="even">
